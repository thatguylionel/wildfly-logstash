Logstash module for Wildfly (http://wildfly.org), based on https://github.com/kifj/wildfly-logstash by the incredible developer Johannes Beck, whom has created this beast of a project.
